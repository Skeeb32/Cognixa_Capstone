  ...
  <v-row>
    <v-col sm="10" class="mx-auto">
      <v-card class="pa-5">
        ...
        <v-text-field label="Title" v-model="post.title" prepend-icon="mdi-account-circle" :rules="rules"></v-text-field>
        <v-text-field label="Real Name" v-model="post.real"  prepend-icon="mdi-account-circle-outline" :rules="rules"></v-text-field>
...
export default{
  ...
  methods: {
    ...
    async submitForm(){
      ...
      formData.append("real", this.post.real)
